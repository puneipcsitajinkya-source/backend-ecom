...
export class SubcategoriesController {
  ...
  @Post()
  async create(@Body() dto: { parentCategoryId: string; name: string; icon?: string; image?: string; images?: string[]; sortOrder?: number; showOnApp?: boolean }) {
    return this.subcategoriesService.create(dto);
  }

  @Patch(':id')
  async update(@Param('id') id: string, @Body() dto: { name?: string; icon?: string; image?: string; images?: string[]; sortOrder?: number; showOnApp?: boolean }) {
